...
export const Render = () => {
    ...
    return (
        ...
        <div className="flex gap-4 justify-center">
          ...
          <div className="w-[300px] top-[356px] left-[78px] absolute h-[200px] bg-white/10 backdrop-blur-lg border border-white/30 rounded-lg shadow-lg overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-blue-500/30 via-purple-500/30 to-pink-500/30 mix-blend-overlay"></div>
            <p className="text-white text-center p-4">Dispersion Glass Effect</p>
        </div>
