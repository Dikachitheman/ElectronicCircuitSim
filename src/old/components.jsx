...
const CircuitComponent = ({id=null, val, thisSelected, setThisSelected, type, xA=null, xB=null, yA=null, yB=null, svgRef, setExistingPoint}) => {
...
// Example usage:
export const Capacitor = ({id=null, val, thisSelected, setThisSelected, xA=null, xB=null, yA=null, yB=null, svgRef, setExistingPoint}) => <CircuitComponent type="Capacitor" val={val} id={id} thisSelected={thisSelected} setThisSelected={setThisSelected} xA={xA} yA={yA} xB={xB} yB={yB} svgRef={svgRef} setExistingPoint={setExistingPoint}/>;
export const Inductor = ({id=null, val, thisSelected, setThisSelected, xA=null, xB=null, yA=null, yB=null, svgRef, setExistingPoint}) => <CircuitComponent type="Inductor" val={val} id={id} thisSelected={thisSelected} setThisSelected={setThisSelected} xA={xA} yA={yA} xB={xB} yB={yB} svgRef={svgRef} setExistingPoint={setExistingPoint}/>;
export const VoltageSource = ({id=null, val, thisSelected, setThisSelected, xA=null, xB=null, yA=null, yB=null, svgRef, setExistingPoint}) => <CircuitComponent type="VoltageSource" val={val} id={id} thisSelected={thisSelected} setThisSelected={setThisSelected} xA={xA} yA={yA} xB={xB} yB={yB} svgRef={svgRef} setExistingPoint={setExistingPoint}/>;